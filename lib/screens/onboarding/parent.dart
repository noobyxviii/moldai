...
class ParentScreen extends StatefulWidget {
  ...
  @override
  State<ParentScreen> createState() => _OnboardingScreenState();
}

class _OnboardingScreenState extends State<ParentScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 15),
              Text(
                "As a parent, I would feel most at ease if I...",
                textAlign: TextAlign.left,
                style: GoogleFonts.poppins(
                  fontSize: 18,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "Knew every food supports growth",
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontWeight: FontWeight.w500,
                        color: Colors.black,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "Could spot harmful ingredients",
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontWeight: FontWeight.w500,
                        color: Colors.black,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "Had an expert guide in my pocket",
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontWeight: FontWeight.w500,
                        color: Colors.black,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      "Don't have to worry about every choice",
                      style: GoogleFonts.poppins(
                        fontSize: 15,
                        fontWeight: FontWeight.w500,
                        color: Colors.black,
