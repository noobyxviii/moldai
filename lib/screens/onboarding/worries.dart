...
class WorriesScreen extends StatefulWidget {
  ...
  @override
  State<WorriesScreen> createState() => _OnboardingScreenState();
}

class _OnboardingScreenState extends State<WorriesScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 25),
              Text(
                "What's your biggest worry about baby food?",
